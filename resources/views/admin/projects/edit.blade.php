...
<form action="{{ route('admin.projects.update', $project) }}" method="POST" class="max-w-4xl mx-auto pb-28">
    @csrf @method('PUT')
        ...
        <div class="space-y-6">
            <div>
                ...
                <div class="relative">
                    ...
                    <input class="input-field pl-10" name="image_url" value="{{ old('image_url', $project->image_url) }}" placeholder="https://example.com/mockup.png" type="url"/>
                </div>
                @if($project->image_url)
                <div class="mt-3 flex items-center gap-3">
                    <img src="{{ $project->image_url }}" class="w-16 h-16 rounded-lg object-cover border border-slate-200" alt="Current thumbnail"/>
                    <span class="text-xs text-slate-400">Current mockup</span>
                </div>
                @endif
            </div>
            <div>
